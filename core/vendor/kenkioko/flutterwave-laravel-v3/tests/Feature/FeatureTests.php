...
class FeatureTests extends TestCase {
    ...
    function creatingCheckSum(Rave $rave) {
        ...
        $rave->initialize("https://azzopay.com");
        $rave = $rave->createCheckSum('https://azzopay.com');
    ...
    function paymentInitialize(Rave $rave) {
        ...
        $response = $rave->eventHandler(new PaymentEventHandler)->initialize("https://azzopay.com");
