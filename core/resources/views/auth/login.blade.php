            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" action="{{route('submitlogin')}}" method="post">
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-neutral btn-block my-4 text-uppercase">{{$lang["login_login"]}}</button>
                  <div class="loginSignUpSeparator"><span class="textInSeparator">or</span></div>
                  <a href="{{route('register')}}" class="btn btn-primary btn-block my-0 text-uppercase">{{$lang["login_create_an_account"]}}</a>
                </div>
              </form>
            </div>
          </div>
