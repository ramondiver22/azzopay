            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">{{$lang['admin_web_home_edit_content']}}</h3>
                    </div>
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            <button type="submit" class="btn btn-success btn-sm">{{$lang['admin_web_home_save']}}</button>
                            </div>
                    </form>
                </div>
                </div>    
                        ...
                        @csrf
                            <div class="form-group">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="customFileLang">{{$lang['admin_web_home_choose_media_1']}}</label>
                                </div>
                            </div>            
                            <div class="text-right">
                            <button type="submit" class="btn btn-success btn-sm">{{$lang['admin_web_home_save_1']}}</button>
                            </div>
                        </form>
                    </div>
                </div>           
                        ...
                        @csrf
                            <div class="form-group">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="customFileLang">{{$lang['admin_web_home_choose_media_2']}}</label>
                                </div>
                            </div>             
                            <div class="text-right">
                            <button type="submit" class="btn btn-success btn-sm">{{$lang['admin_web_home_save_2']}}</button>
                            </div>
                        </form>
                    </div>
                </div>            
                        ...
                        @csrf
                            <div class="form-group">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="customFileLang">{{$lang['admin_web_home_choose_media_4']}}</label>
                                </div>
                            </div>                  
                            <div class="text-right">
                            <button type="submit" class="btn btn-success btn-sm">{{$lang['admin_web_home_save_4']}}</button>
                            </div>
                        </form>
                    </div>
                </div>                                 
