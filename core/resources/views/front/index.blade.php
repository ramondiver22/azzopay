        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 m-15px-tb">
                ...
                <div class="border-left-2 border-color-theme p-25px-l m-35px-t">
                    ...
                    <p>{{$lang["front_stimulate_your_sales"]}}</p>
                </div>
                <div class="p-20px-t">
                ...
                <div class="row">
                    <div class="col-lg-12 col-sm-6 ">
                        <div class="media p5">
                            ...
                            <div class="media-body p-15px-l">
                                <h6 class="m-20px-t">{{$lang["front_storefront"]}}</h6>
                            </div>
                        </div>
                    </div>                  
                    <div class="col-lg-12 col-sm-6">
                        <div class="media p5">
                            ...
                            <div class="media-body p-15px-l">
                                <h6 class="m-20px-t">{{$lang["front_transfer_request_money"]}}</h6>
                            </div>
                        </div>
                    </div>                    
                    <div class="col-lg-12 col-sm-6 m-15px-tb">
                        <div class="media p5">
                            ...
                            <div class="media-body p-15px-l">
                                <h6 class="m-20px-t">{{$lang["front_bill_payment"]}}</h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 m-15px-tb">
                <div class="row">
                    <div class="col-lg-12 col-sm-6">
                        <div class="media p5">
                            <div class="media-body">
                                <h6 class="m-20px-t">{{$lang["front_payment_pages"]}}</h6>
                            </div>
                    ...
                    <div class="col-lg-12 col-sm-6">
                        <div class="media p5">
                            <div class="media-body p-15px-l">
                                <h6 class="m-20px-t">{{$lang["front_invoice_payment"]}}</h6>
                            </div>
                            <div class="icon-70 box-shadow-lg theme-color border-radius-50">
                    ...
                    <div class="col-lg-12 col-sm-6">
                        <div class="media p5">
                            <div class="media-body p-15px-l">
                                <h6 class="m-20px-t">{{$lang["front_virtual_cards"]}}</h6>
                            </div>
                            <div class="icon-70 box-shadow-lg theme-color border-radius-50">
    ...
    <div class="container">
        <div class="row justify-content-center md-m-25px-b m-40px-b">
            <div class="col-lg-6 text-center">
                <h3 class="h1 m-0px">{{$lang["front_join_millions_who_choose"]}} {{$set->site_name}} {{$lang["front_worldwide"]}}</h3>
                <div class="p-20px-t">
                    <a class="m-btn m-btn-dark m-btn-radius" href="{{route('register')}}">{{$lang["front_sign_up_for_free"]}} </a>
                </div>
            </div>
        </div>
    </div>
