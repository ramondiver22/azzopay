  ...
  <div class="content-wrapper">
    <div class="card">
        <div class="card-header">
            <h3 class="mb-0 font-weight-bolder">{{$lang["donation_transactions_for"]}}{{$val->ddlink->name}}</h3>
        </div>
        ...
        <table class="table table-flush" id="datatable-buttons">
            ...
            <tbody>  
                    ...
                    <td>@if($val->sender_id==$user->id) {{$lang["donation_paid"]}} @else {{$lang["donation_received"]}} @endif</td>
