          ...
          <div class="card-body pt-7 px-5">
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <div class="text-center text-dark mb-5">
                        <div class="btn-wrapper text-center">
                            <a href="{{route('user.pixpay', ['id' => $product->ref_id])}}" class="btn btn-neutral btn-icon mb-3">
                                <span class="btn-inner--icon">
                                  <img src="{{url('asset/images/pix-icon-blue.png')}}" style="width: 25px; height: 25px;" />
                                </span>
                            </a>
                            <p class="text-xs text-uppercase">{{$lang["product_sask_pay_with_pix"]}}</p> 
                        </div>
                    </div>            
                    @endif     
                </div>
                ...
                <div class="col-6">
                    ...
                    <div class="text-center text-dark mb-5">
                        <div class="btn-wrapper text-center">
                            <a href="{{route('user.boletopay', ['id' => $product->ref_id])}}" class="btn btn-neutral btn-icon mb-3">
                                <span class="btn-inner--icon"><i class="fad fa-barcode"></i></span>
                            </a>
                            <p class="text-xs text-uppercase">{{$lang["product_sask_pay_with_boleto"]}}</p> 
                        </div>
                    </div>                   
                    @endif             
                </div>
                ...
                <div class="col-6">
                    ...
                    <div class="text-center text-dark mb-5">
                        <div class="btn-wrapper text-center">
                            ...
                            <p class="text-xs text-uppercase">{{$lang["product_pay_with_card"]}}</p> 
                        </div>
                    </div>            
                    @endif     
                </div>
                ...
                <div class="col-6">
                    ...
                    <div class="text-center text-dark mb-5">
                        <div class="btn-wrapper text-center">
                            ...
                            <p class="text-xs text-uppercase">{{$lang["product_pay_with_account"]}}</p> 
                        </div>
                    </div>               
                    @endif                 
                </div>
