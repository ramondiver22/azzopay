          ...
          <div class="card-body pt-7 px-5">
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <div class="text-center text-dark mb-5">
                        <div class="btn-wrapper text-center">
                            <a href="{{route('user.spixpay', ['id' => $cart])}}" class="btn btn-neutral btn-icon mb-3">
                ...
                <div class="col-6">
                    ...
                    <div class="text-center text-dark mb-5">
                        <div class="btn-wrapper text-center">
                            <a href="{{route('user.sboletopay', ['id' => $cart])}}" class="btn btn-neutral btn-icon mb-3">
                ...
                <div class="col-6">
                    ...
                    <div class="text-center text-dark mb-5">
                        <div class="btn-wrapper text-center">
                            ...
                            <p class="text-xs text-uppercase">{{$lang["product_sask_pay_with_card"]}}</p> 
                        </div>
                    </div>                    
                    @endif  
                </div>   
                ...
                <div class="col-6">
                    ...
                    <div class="text-center text-dark mb-5">
                        <div class="btn-wrapper text-center">
                            ...
                            <p class="text-xs text-uppercase">{{$lang["product_sask_pay_with_account"]}}</p> 
                        </div>
                    </div>                       
                    @endif              
                </div>
