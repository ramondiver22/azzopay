...
class UserController extends Controller
{
    ...
    //Merchant
        ...
        public function Verifypayment()
        {
            ...
            curl_setopt($ch, CURLOPT_URL, 'https://azzopay.com/pay/api/verify-payment/deff/r1Kn6nzk1cE63rQE');
            $result = curl_exec($ch);
            curl_close($ch);
    ...
    //Transfer Money
        ...
        public function submitownbank(Request $request) {
            ...
            if (!filter_var($request->email, FILTER_VALIDATE_EMAIL)) {
                return back()->with('alert', 'E email {$request->email} não é um E-mail válido.');
            }

            $check=User::whereEmail(strtolower($request->email))->first();
            if (!$check) {
                return back()->with('alert', 'O E-mail informado não está cadastrado no sistema.');
            }
