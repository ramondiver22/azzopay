...
function populateStates( countryElementId, stateElementId ){
	...
	stateElement.options[0] = new Option('Selecione o Estado','');
...
function populateCountries(countryElementId, stateElementId){
	...
	countryElement.options[0] = new Option('Selecione o País','-1');
...
function populateCategory( industryElementId, categoryElementId ){
	...
	categoryElement.options[0] = new Option('Selecione a Categoria','');
...
function populateIndustry(industryElementId, categoryElementId){
	...
	industryElement.options[0] = new Option('Selecione a Indústria','-1');
